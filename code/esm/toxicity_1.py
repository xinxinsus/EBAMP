...
FASTA_PATH = "../../attributes/toxicity_p.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/toxicity_p/" # Path to directory of embeddings for P62593.fasta
EMB_LAYER = 33
ys = []
Xs = []
cate = []
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    ...
    cate.append(1)
FASTA_PATH = "../../attributes/toxicity_n.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/toxicity_n/" # Path to directory of embeddings for P62593.fasta
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    scaled_effect = header.split('|')[-1]
    ys.append(scaled_effect)
    fn = f'{EMB_PATH}/{str(scaled_effect)}.pt'
...
f = open('./esm_toxicity_idxes.txt','w')
idxes = []
...
writer = pd.ExcelWriter('./esm_toxicity_train.xlsx')
