...
FASTA_PATH = "../../attributes/spectrum_p.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/spectrum_p/" # Path to directory of embeddings for P62593.fasta
EMB_LAYER = 33
ys = []
Xs = []
cate = []
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    ...
    cate.append(1)
FASTA_PATH = "../../attributes/spectrum_n.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/spectrum_n/" # Path to directory of embeddings for P62593.fasta
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    scaled_effect = header.split('|')[-1]
    ys.append(scaled_effect)
    fn = f'{EMB_PATH}/{str(scaled_effect)}.pt'
...
f = open('./esm_spectrum_idxes.txt','w')
idxes = []
...
writer = pd.ExcelWriter('./esm_spectrum_train.xlsx')
