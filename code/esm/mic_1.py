...
FASTA_PATH = "../../attributes/mic_p.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/micpos/" # Path to directory of embeddings for P62593.fasta
EMB_LAYER = 33
ys = []
Xs = []
cate = []
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    ...
    cate.append(1)
FASTA_PATH = "../../attributes/mic_n.fasta" # Path to P62593.fasta
EMB_PATH = "../../attributes/micneg/" # Path to directory of embeddings for P62593.fasta
for header, _seq in esm.data.read_fasta(FASTA_PATH):
    scaled_effect = header.split('|')[-1]
    ys.append(scaled_effect)
    fn = f'{EMB_PATH}/{str(scaled_effect)}.pt'
...
writer = pd.ExcelWriter('./esm_mic_train.xlsx')
